...
- **Frontend**: https://avishu-fashion.vercel.app
- **Backend API**: https://maussym-avishu-backend.hf.space
- **Stylist API**: https://fashion-hack.onrender.com
...
| Deployment | Vercel (frontend), HuggingFace Spaces (backend), Render (stylist), Qdrant Cloud |
...
- **Stylist**: Render (Docker container with PyTorch CPU)
...
- **Фронтенд**: https://avishu-fashion.vercel.app
- **Backend API**: https://maussym-avishu-backend.hf.space
- **Stylist API**: https://fashion-hack.onrender.com
...
| Деплой | Vercel (frontend), HuggingFace Spaces (backend), Render (stylist), Qdrant Cloud |
...
- **Stylist**: Render (Docker-контейнер с PyTorch CPU)
